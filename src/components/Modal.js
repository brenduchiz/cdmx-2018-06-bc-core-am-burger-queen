...
restorepassword() {
    ...
    auth.sendPasswordResetEmail(this.state.emailRestor).then(function() {
  ...
  render() {
    ...
    <Button color="light-blue accent-2" onClick={this.restorepassword} type="submit">Enviar<i className="fa fa-paper-plane-o ml-2"></i></Button>
    </div>
